    ...
    <div className={styles.seasonWpapper}>
      ...
      <div className={styles.content}>
        ...
        <div className={styles.text}>
          On this website you can find 150 the most popular TV shows over the
          last 30 years with the highest rating on IMDb; Here is how it works:
          ...
          <section className={styles.stepsSection}>
            ...
            <div className={styles.stepsText}>
              ...
              seen the show not once, but 3 times? Click on the edit icon and
              you will be able to change data.
            </div>
          </section>
          <section className={styles.stepsSection}>
            <div className={styles.stepsTitle}>Step 4: Edit data</div>
            <div className={styles.stepsText}>
              If you press on the edit icon you can unchecked seasons you
              haven't seen and change the number of times you have seen show.
            </div>
          </section>
          {/* <section className={styles.stepsSection}>
          ...
          <section className={styles.stepsSection}>
            ...
            <div className={styles.stepsText}>
              The information on how much time you spent watching TV shows
              always on the screen. It updates every time you add or remove a
              show on your list or change the number of times and seasons you
              have watched. If you want to start over press the reset button.
            </div>
          </section>
          {/* <section className={styles.stepsSection}>
          <div className={styles.stepsTitle}>
          ...
          <section className={styles.stepsSection}>
            ...
            <div className={styles.stepsText}>
              ...
              free. The price you are paying is your time.
            </div>
          </section>
          <section className={styles.stepsSection}>
            <div className={styles.stepsTitle}> What else should you know?</div>
            <div className={styles.stepsText}>
              To calculate the result program uses the number of seasons, how
              many episodes every season has and average duration of one
              episode. If the TV show is still running, the program calculates
              the number of episodes that have been shown as on January 23,
              2023; If you have any question regards to this project please
              write the message to code94041@gmail.com
            </div>
          </section>
        </div>
      </div>
